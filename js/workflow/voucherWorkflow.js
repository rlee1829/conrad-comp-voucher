    ...
    modal({
      ...
      wire: function (b) {
        function r() {
          ...
          else if (f.t === 'cat') w.innerHTML = '<label>' + t('값') + '</label><select id="fs-val"><option value="VIP">' + t('For VIP') + '</option><option value="COMPLAINT">' + t('컴플레인 보상') + '</option><option value="STAFF">' + t('직원 복리후생') + '</option><option value="PARTNER">' + t('제휴/마케팅') + '</option><option value="WEDDING">' + t('웨딩') + '</option></select>';
